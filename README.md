...
ShellSort (gap = N/ (2^k))|1|10|100|1000|10.000|100.000|1.000.000|10.000.000
---|---:|---:|---:|---:|---:|---:|---:|---:
...
ShellSort = HibbardSort (gap = 2^k - 1)|1|10|100|1000|10.000|100.000|1.000.000|10.000.000
---|---:|---:|---:|---:|---:|---:|---:|---:
...
в HibbardSort имеем статистическую погрешность из-за постороения последовательности Хиббарда 
